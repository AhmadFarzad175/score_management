...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="header best-shadow">

            <div class="header-left">
                <a href="index.html" class="logo">
                    <img src="{{ asset('images/softelino-logo.png') }}" style="height:100%;" alt="Logo">
                </a>
            ...
            <div class="menu-toggle ">
                <a href="javascript:void(0);" id="toggle_btn" class="best-shadow"
            ...
            <div class="">
                <a class="mobile_btn best-shadow" id="mobile_btn" style="background-color: transparent; color: black">
                    <i class="fas fa-bars"></i>
                </a>
            </div>
        ...
        <div class="sidebar best-shadow" id="sidebar">
